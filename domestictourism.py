...
X = covidfactors[['log_international', 'log_income', 'log_le', 'log_me', 'log_domestic_per_cap']].values
...
X = covidfactors[['total_international', 'domestic_per_cap']].values
...
# sns.scatterplot(data=covidfactors, x='log_tourists_per_cap', y='log_domestic_per_cap', hue='labels', legend='full')
# plt.show()
#
