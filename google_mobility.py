...
covidfactors = covidfactors[['country', 'log_deaths_per_cap', 'log_income', 'log_le', 'log_me']]
# print(covidfactors.head())

covid_mob = covidfactors.merge(agg_gmob, how='inner')
# print(covid_mob.head())

X = covid_mob[['log_rec', 'log_groc', 'log_parks', 'log_transit', 'log_work', 'log_home', 'log_income',
               'log_le', 'log_me']].values
